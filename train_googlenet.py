...
def main():
    parser = argparse.ArgumentParser(description='Train GoogLeNet on VinaFood21')
    ...
    parser.add_argument('--save-path', type=str, default='./checkpoints/googlenet_vinafood.pt')
