...
from models import PretrainedResNet50
...
def main():
    parser = argparse.ArgumentParser(description='Fine-tune pretrained ResNet50 on VinaFood21')
    ...
    parser.add_argument('--save-path', type=str, default='./checkpoints/resnet50_pretrained_vinafood.pt')
    ...
    if is_main_process():
        print(f'Model: Pretrained ResNet50 (microsoft/resnet-50)')
