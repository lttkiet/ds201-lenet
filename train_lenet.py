...
from data_utils.loaders import get_mnist_loaders
...
def main():
    ...
    parser.add_argument('--save-path', type=str, default='./checkpoints/lenet_mnist.pt')
    ...
    train_loader_tmp, _, train_dataset, test_dataset = get_mnist_loaders(
    ...
    # Implement test run with limited samples
    if args.test_run:
        ...
        # Limit test samples (use half of test_samples)
